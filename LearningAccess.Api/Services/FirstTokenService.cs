...
{
	public class FirstTokenService : ITokenService
	{
		private AuthorizationToken token = new AuthorizationToken();
		private readonly IOptions<FirstAuthorizationSettings> authorizeSettings;

		public FirstTokenService(IOptions<FirstAuthorizationSettings> authorizeSettings)
		{
